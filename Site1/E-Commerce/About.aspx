<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="Site1.E_Commerce.About" %>
...
<body>
    <form id="form1" runat="server">
        <div>
           ...
           <!-- Header-->
            <header>
                <div class="jumbotron text-center" style="margin-bottom: 0; background-color:darkcyan;  color :#ffffff">
                    <h1>BoAt-X </h1>
                    <p>The Best Indian Online Store to Buy Amazing and High Quality Headphones </p>
                </div>
                <!-- Navbar -->
