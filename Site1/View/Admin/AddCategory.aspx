...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="alert">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="form-group">
                    <asp:GridView ID="GridView1" HeaderStyle-BackColor="#0099ff" HeaderStyle-ForeColor="White" CssClass="table table-hover" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="CID">
                        <Columns>
