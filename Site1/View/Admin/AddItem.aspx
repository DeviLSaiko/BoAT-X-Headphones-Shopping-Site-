        ...
        <div class="col-sm-2"></div>
            <div class="col-sm-6">
                <div class="form-group">
                   ...
                   <div class="form-group">
                       <asp:Button ID="BtnAdd" CssClass="btn btn-info" runat="server" Text="Add Item" OnClick="BtnAdd_Click" />
                </div>
            </div>
    </div>
     <div class="page-header">
        <h3>Added Items List</h3>
    </div>
    <div class="row">
         <div class="col-sm-4"></div>
        <div class="col-sm-12">
            <div class="table-responsive" >
                <asp:GridView ID="GridView1"  runat="server" class="table table-hover" HeaderStyle-ForeColor="#ffffff" HeaderStyle-BackColor="#0099ff" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="IID" DataSourceID="SqlDataSource1">
                    <Columns>
