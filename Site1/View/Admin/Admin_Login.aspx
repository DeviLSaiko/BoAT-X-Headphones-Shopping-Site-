<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Login.aspx.cs" Inherits="Site1.View.Admin.Admin_Login" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav">
                                <li ><a href="../../E-Commerce/Home.aspx">Home</a></li>
                          <!--  <li><a href="About.aspx">About</a></li>
                           ...
                           <!--     <li><a href="Login.aspx"><span class="glyphicon glyphicon-log-in"></span> Login </a></li>
                                <li><a href="SignUp.aspx"><span class="glyphicon glyphicon-log-out"></span>  SignUp </a></li>-->
                                <li class="active"><a href="../View/Admin/Admin_Login.aspx"><span class="glyphicon glyphicon-knight"></span> Admin </a></li> 
                            </ul>
                        </div>
                    </div>
                </nav>
              ...
              <div class="panel-body">
                  ...
                  <div class="row">
                      <div class="col-sm-12">
                          ...
                          <div class="form-group">
                                <asp:Button ID="btnLog" runat="server"  CssClass="btn btn-success" Text="Login" OnClick="btnLog_Click"></asp:Button>
